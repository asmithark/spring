...
import com.example.sb1.controller.PersonController;
...
public class PersonControllerTest {
    ...
    public void getPersonByIdTest() {
        ...
        ResponseEntity<Person> actual = personController.getPersonById((int) id);
        assertNotNull(actual);
    }
    ...
    public void updatePersonTest() {
        ...
        ResponseEntity<Person> actual = personController.updatePerson((int) id, person1);
        assertNotNull(actual);
    ...
    public void deletePersonTest() {
        ...
        personController.deletePerson((int) id);
